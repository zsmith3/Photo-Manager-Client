...
class LoginPage extends React.Component<{
	classes: { center: string; paper: string };
	width: Breakpoint;
	history: any;
}> {
	static styles = {
				...
				<Grid container spacing={24}>
					...
					<Grid item xs={12} sm={6} md={4} lg={3} className={this.props.classes.center}>
						<Paper elevation={4} className={this.props.classes.paper}>
							...
							<Typography component="p">Please log in to access private files.</Typography>
							...
							<form onSubmit={this.handleSubmit.bind(this)}>
								...
								<FormControlLabel
									control={<Checkbox checked={this.state.remain_in} onChange={event => this.setState({ remain_in: event.target.checked })} />}
